...
class PdfApiPark {
  static Future<File> generateTable(form) async {
    ...
    final headersTravel = ['Parque/Destino/Lazer', 'Detalhes'];
    ...
    final travel = [
      PdfScreen(QuestionTravel:  'Nome:', AswerTravel: dataTravel['title']),
      PdfScreen(QuestionTravel: 'Cidade:', AswerTravel: dataTravel['cidade']),
      PdfScreen(QuestionTravel:  'País:', AswerTravel: dataTravel['pais']),
      PdfScreen(QuestionTravel: 'Período de início', AswerTravel: dataTravel['periodo']),
      PdfScreen(QuestionTravel:  'Data:', AswerTravel: dataTravel['data']),
      PdfScreen(QuestionTravel: 'Tipo de lazer:', AswerTravel: dataTravel['tipo']),
      PdfScreen(QuestionTravel:  'Endereço:', AswerTravel: dataTravel['endereco']),
    ];
