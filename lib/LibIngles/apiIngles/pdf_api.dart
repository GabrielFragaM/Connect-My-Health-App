...
class PdfApiHotel {
  static Future<File> generateTable(form) async {
    ...
    final headersTravel = ['Hotel', 'Details'];
    ...
    final travel = [
      PdfScreen(QuestionTravel:  'Host name:', AswerTravel: dataTravel['title']),
      PdfScreen(QuestionTravel: 'Hosting city:', AswerTravel: dataTravel['cidade']),
      PdfScreen(QuestionTravel:  'Host country:', AswerTravel: dataTravel['pais']),
      PdfScreen(QuestionTravel: 'Duration time (in days):', AswerTravel: dataTravel['tempo']),
      PdfScreen(QuestionTravel:  'Check-in date :', AswerTravel: dataTravel['data']),
      PdfScreen(QuestionTravel: 'Reason for hosting:', AswerTravel: dataTravel['motivo']),
      PdfScreen(QuestionTravel:  'Hosting Address:', AswerTravel: dataTravel['endereco']),
    ];
