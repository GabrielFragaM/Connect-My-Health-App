...
class PdfApiPark {
  static Future<File> generateTable(form) async {
    ...
    final headersTravel = ['Park/Destination/Leisure', 'Details'];
    ...
    final travel = [
      PdfScreen(QuestionTravel:  'Name:', AswerTravel: dataTravel['title']),
      PdfScreen(QuestionTravel: 'City:', AswerTravel: dataTravel['cidade']),
      PdfScreen(QuestionTravel:  'Country:', AswerTravel: dataTravel['pais']),
      PdfScreen(QuestionTravel: 'Start period', AswerTravel: dataTravel['periodo']),
      PdfScreen(QuestionTravel:  'Date:', AswerTravel: dataTravel['data']),
      PdfScreen(QuestionTravel: 'Type of leisure:', AswerTravel: dataTravel['tipo']),
      PdfScreen(QuestionTravel:  'Address:', AswerTravel: dataTravel['endereco']),
    ];
