...
import 'package:loja_virtual/LibIngles/blocsIngles/perfis_bloc.dart';
import 'package:loja_virtual/LibIngles/validatorsIngles/perfil_validator.dart';
import 'package:loja_virtual/LibIngles/modelsIngles/user_model.dart';
import 'package:flutter/cupertino.dart';
import 'package:loja_virtual/LibIngles/widgetsIngles/images_widget.dart';
import 'package:loja_virtual/LibIngles/widgetsIngles/images_widget2.dart';
import 'package:loja_virtual/LibIngles/widgetsIngles/images_widget3.dart';
  ...
  Widget build(BuildContext context) {
    ...
    void saveForm() async {
      if (_formKey.currentState.validate()) {
        ...
        _scaffoldKey.currentState.showSnackBar(SnackBar(
          content: Text(
            success ? "Profile saved!" : "Error saving a new Profile!",
            style: TextStyle(color: Colors.white),
          ),
          backgroundColor: Colors.blue,
        ));
        ...
        _scaffoldKey.currentState.showSnackBar(SnackBar(
          content: Text(
            "You must have all data filled in before saving!",
            style: TextStyle(color: Colors.white),
          ),
      ...
      appBar: AppBar(
        ...
        title: StreamBuilder<bool>(
            ...
            builder: (context, snapshot) {
              return Text(snapshot.data ? "Edit Profile" : "New Profile");
            }),
        actions: <Widget>[
          StreamBuilder<bool>(
            stream: _formBloc.outCreated,
                        ...
                        _createStepper(
                            ...
                            Column(children: [
                              ...
                              TextFormField(
                                ...
                                keyboardType: TextInputType.number,
                                style: _fieldStyle,
                                decoration: _buildDecoration("Age"),
                              ),
                              TextFormField(
                                ...
                                style: _fieldStyle,
                                decoration: _buildDecoration("Nationality"),
                              ),
                              TextFormField(
                        ...
                        _createStepper(
                            ...
                            Column(children: [
                              ...
                              TextFormField(
                                ...
                                style: _fieldStyle,
                                decoration: _buildDecoration("City"),
                              ),
                              TextFormField(
                                ...
                                style: _fieldStyle,
                                decoration: _buildDecoration("Country"),
                              ),
                            ])),
                      ]);
                }),
