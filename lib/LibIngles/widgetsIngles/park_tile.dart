...
import 'package:loja_virtual/LibIngles/screensIngles/park_screen.dart';
import 'package:loja_virtual/LibIngles/screensIngles/park_screen_details.dart';

import 'edit_park_category_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Card(
        ...
        builder: (context) => EditParkCategoryDialog(
           category: category,
      )
    );
            },
