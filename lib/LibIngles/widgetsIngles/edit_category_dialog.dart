...
import 'package:loja_virtual/LibIngles/blocsIngles/category_bloc.dart';
      ...
      appBar: AppBar(
        title: StreamBuilder<String>(
            ...
            builder: (context, snapshot) {
              return Text(snapshot.hasData ? "Edit Trip" : "New Trip");
            }),
        elevation: 0,
        actions: <Widget>[
                        ...
                        steps: [
                          ...
                          _createStepper(
                              ...
                              Column(children: [
                                ...
                                Text('Name Hotel/Address Accommodation ?             '),
                                TextFormField(
