...
import 'package:loja_virtual/blocs/parkCategory_bloc.dart';
      ...
      appBar: AppBar(
        title: StreamBuilder<String>(
            ...
            builder: (context, snapshot) {
              return Text(snapshot.hasData ? "Editar" : "Novo");
            }),
        elevation: 0,
        actions: <Widget>[
                          ...
                          _createStepper(
                              ...
                              Column(
                                children: [
                                  ...
                                  Text('Nome do Parque/Lugar/Lazer... ?                                            '),
                                  TextFormField(
                                  ...
                                  Column(children: [
                                    RadioButton(
                                      description: "Show/Balada/Festa",
                                      value: "Show/Balada/Festa",
                                    ...
                                    RadioButton(
                                      description: "Parque de diversão",
